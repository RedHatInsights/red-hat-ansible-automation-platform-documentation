...
= Getting started with Catalog_overview
...
Once the portfolio is created, we can add products to it and share the portfolio with groups of users.

include::modules/con_Adding_products_to_portfolio.adoc[]

The final step in this workflow is to share the portfolio with groups of users. Once shared, users will have access to order to products.
