// This is the release notes for Automation Controller 4.3 for AAP 2.3 release, the version number is removed from the topic title as part of the release notes restructuring efforts.
