...
Contains main assembly files and symbolic links to the `assemblies` and `modules` directories.
...
### Building titles and user stories

Render asciidoc as HTML before reviewing content or to check for formatting and markup issues.

. Install `asciidoctor` if necessary.
. Build titles and user stories as follows:

-----
$ asciidoctor path/to/master.adoc
-----

-----
$ asciidoctor path/to/<title_name>.asciidoc
-----

-----
$ asciidoctor path/to/assembly-<story_name>.adoc
-----
