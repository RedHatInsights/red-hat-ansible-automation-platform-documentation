...
[role="_abstract"]
Once network peering is performed and your Azure routing configuration is established, you can choose how your team will access the software through your Azure network configuration.
