...
[role="_abstract"]
This document provides guidance for improving the security posture of your {PlatformName} (AAP) deployment on Red Hat Enterprise Linux (RHEL).
...
[NOTE]
====
These recommendations do not guarantee security or compliance of your deployment of AAP. You must assess security from the unique requirements of your organization to address specific threats and risks and balance these against implementation factors.
====
