...
| `cdn.quay.io` | Access to container images provided by Red Hat and partners
| `cdn01.quay.io` | Access to container images provided by Red Hat and partners
| `cdn02.quay.io` | Access to container images provided by Red Hat and partners
| `cdn03.quay.io` | Access to container images provided by Red Hat and partners
|===
