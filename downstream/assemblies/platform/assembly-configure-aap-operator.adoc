...
Before you can deploy the central configuration you need to have {OperatorPlatform} installed in a namespace. 
...
If you have the {OperatorPlatform} and some or all of the {PlatformNameShort} components installed see <<Deploying your central configuration with existing {PlatformNameShort} components>> for how to proceed. 
