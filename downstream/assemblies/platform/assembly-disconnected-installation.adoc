...
ifdef::context[:parent-context-of-disconnected-installation: {context}]
...
ifdef::context[]
[id="disconnected-installation_{context}"]
endif::[]
...
////
ifdef::parent-context-of-disconnected-installation[:context: {parent-context-of-disconnected-installation}]
ifndef::parent-context-of-disconnected-installation[:!context:]
