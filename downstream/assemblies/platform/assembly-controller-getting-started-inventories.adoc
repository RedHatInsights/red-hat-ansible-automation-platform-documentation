[id="controller-getting-started-inventories"]
...
include::platform/proc-controller-getting-started-inventory.adoc[leveloffset=+1]
include::platform/con-controller-getting-started-groups-hosts.adoc[leveloffset=+1]
include::platform/proc-controller-getting-started-add-groups-hosts.adoc[leveloffset=+1]