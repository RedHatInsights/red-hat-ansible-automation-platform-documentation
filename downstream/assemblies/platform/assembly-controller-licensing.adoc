...
{PlatformName} controller ("{Controller Name}") is a software product provided as part of an annual {PlatformName} subscription entered into between you and Red Hat, Inc. ("Red Hat").
