...
Also, clustered instances can be grouped into different pools or queues, called xref:controller-instance-groups[Instance groups].

{PlatformNameShort} supports container-based clusters using Kubernetes, meaning you can install new {ControllerName} instances on this platform without any variation or diversion in functionality. 
