...
* When installing {PlatformNameShort} on {OCP} you must install Single Sign-On seperately.
...
For more information on running operators on {OCPShort}, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.10/html/operators/index[Working with Operators in {OCPShort}] in the {OCPShort} product documentation.
