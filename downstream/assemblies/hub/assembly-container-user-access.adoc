...
[role="_abstract"]
Configure user access for container repositories in your private {HubName} to provide permissions that determine who can access and manage images in your {PlatfomNameShort}.
