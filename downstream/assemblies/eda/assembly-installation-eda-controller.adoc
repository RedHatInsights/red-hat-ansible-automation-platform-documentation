...
The installation of Event-Driven Ansible automation controller coincides with other Ansible Automation Platform components. Like automation controller and automation hub, the setup includes default settings for specific variables in the inventory files.
