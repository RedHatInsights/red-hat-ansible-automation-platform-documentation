...
= Installation of {EDAname} controller

:context: installation-of-eda-controller

The installation of Event-Driven Ansible automation controller happens along with other Ansible Automation Platform components. Like automation controller and automation hub, the setup includes default settings for specific variables in the inventory files.
