...
The installation of {EDAcontroller} occurs at the same time as the installation for other {PlatformNameShort} components. Like {ControllerName} and {HubName}, the setup includes default settings for specific variables in the inventory files.
