...
The rulebooks of a project must be located in the `/rulebooks` folder at the root of the project or at the path defined for {EDAName} content in Ansible collections: `/extensions/eda/rulebooks`.
