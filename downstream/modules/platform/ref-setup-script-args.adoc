...
|`rekey_catalog`|When you execute the `setup.sh` script using this variable set to `true`, by default, a new secret key is generated and distributed for both the automation controller and the automation services catalog.|`False`
|====
