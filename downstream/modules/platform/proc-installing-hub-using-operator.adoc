...
. Select {HubNameStart} tab and click btn:[Create {HubNameStart}].
...
<2> Set this to the name of the secret created in xref:proc-creating-a-secret_{context}[Creating a Secret to hold the Red Hat Single Sign On connection details].
+
[Note]
====
