...
[role="_abstract"]
This example describes how you can populate the inventory file to deploy a single instance of {HubName} with an external database that is not managed by the platform installer.
