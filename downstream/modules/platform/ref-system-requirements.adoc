...
[NOTE]
====
You must install Ansible using a package manager such as `yum`, and the latest stable version of the package manage must be installed for {PlatformName} to work properly. 
