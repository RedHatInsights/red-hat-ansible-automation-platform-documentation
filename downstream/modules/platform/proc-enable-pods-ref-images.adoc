...
Alternatively, if the `ImagePullSecret`` already exists in the container group namespace, you can specify the `ImagePullSecret`` on the custom pod specification for the ContainerGroup.
