...
When {HubName} is installed and you know the URL of the instance, the RH-SSO client must be updated to set the Valid Redirect URIs and Web Origins settings.
