...
. Download the AAP setup bundle package by navigating to
https://access.redhat.com/downloads/content/480 and click btn:[Download Now] for the Ansible Automation Platform {PlatformVers} Setup Bundle.
