...
| *`nginx_http_port`* | The nginx HTTP server listens to port 80 for inbound connections.

Default = 80
| *`nginx_https_port`* | The nginx HTTPS server listens to port 443 for secure connections.
