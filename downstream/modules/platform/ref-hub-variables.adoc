...
| *`nginx_hsts_max_age`* | This variable specifies how long, in seconds, you want the client to treat you as a _HTTP Strict Transport Security_ (HSTS) host. That is, how long you want them to contact you using HTTPS exclusively.
