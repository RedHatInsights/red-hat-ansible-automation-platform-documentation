...
You can [ADD XREF]:customize the text content of each xref:controller-notification-types[Notification type] on the notification form.
...
For a list of supported attributes and the proper syntax construction, see the [ADD XREF]Supported Attributes for Custom Notifications section.
