...
+
NOTE: See the _Installation Guide_ to review information about `inventory` file requirements.
...
* Append `node_state-deprovision` to the node or group as follows:
+
For more information, see _Deprovisioning individual nodes or groups_.
...
* link:https://access.redhat.com/documentation/en-us/red_hat_ansible_automation_platform/{PlatformVers}/html/red_hat_ansible_automation_platform_automation_mesh_guide/assembly-deprovisioning-mesh[Deprovisioning individual nodes or groups]
