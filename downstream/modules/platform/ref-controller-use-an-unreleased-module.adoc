...
If there is a feature that is available in the latest Ansible core branch that you want to use with your {ControllerName} system, making use of it in {ControllerNMame} is simple.
