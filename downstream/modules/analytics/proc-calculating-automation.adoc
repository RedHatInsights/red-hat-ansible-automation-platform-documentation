...
You can tune this calculation by providing more specific organizational cost information and adjusting the time values for each of the top templates. The total savings will update dynamically as you edit each field.
...
*Total savings* will update based on the information you enter in each field.
