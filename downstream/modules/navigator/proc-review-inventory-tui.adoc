...
= Reviewing inventory from the {Navigator} textual user interface

[role="_abstract"]

You can review Ansible inventories with the {Navigator} textual user interface in interactive mode and delve into groups and hosts for more details.
