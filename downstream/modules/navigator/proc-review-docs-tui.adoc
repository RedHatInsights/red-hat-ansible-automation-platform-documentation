...
. Review the module you are interested in. Alternately, you can type `ansible-navigator doc` to directly access the documentation.
+
----
...
+
See xref:ref-navigator-general-settings_settings-navigator[] for details on how to set up your editor.
