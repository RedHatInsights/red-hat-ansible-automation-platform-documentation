...
For more information on permissions, see link:https://access.redhat.com/documentation/en-us/red_hat_ansible_automation_platform/{PlatformName}/html/getting_started_with_automation_hub/index#assembly-user-access[Managing user access in Automation Hub].
