...
[role="_abstract"]
To allow the {PlatformNameShort} application to access and manage Azure resources, you must provide authorization credentials.
The Microsoft Azure collection supports service principal authentication after deployment.
