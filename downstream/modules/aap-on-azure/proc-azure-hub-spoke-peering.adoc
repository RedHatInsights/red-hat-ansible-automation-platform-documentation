...
** The CIDR blocks of the {AAPonAzureNameShort} VNet from the managed resource group of the application. Refer to xref:proc-azure-find-cluster-cidr[Finding the CIDR Block of the managed resource group] for instructions.
