...
If you have collections `A`, `B`, and `C` in your requirements file, and a new collection `X` is added to {Console} that you wish to use, you must add `X` to your requirements file for {PrivateHubName} to synchronize it.
