...
By default, your {PrivateHubName} community repository directs to `https://galaxy.ansible.com/api/`.
...
The *Sync status* notification updates to notify you of completion or failure of {Galaxy} collections synchronization to your {PrivateHubName}.
