...
. In the *Community* remote, click image:ellipsis.png[More actions] and select *Edit*.
...
. Click image:ellipsis.png[More actions] and select *Sync* to sync collections from {Galaxy} and {HubNameMain}.
