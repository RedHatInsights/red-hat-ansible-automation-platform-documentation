...
// Hherbly--removed attributes for catalog since it is deprecated for AAP 2.4. See: AAP-12573
...
:EDAName: Red Hat Event-Driven Ansible
:EDANameShort: Event-Driven Ansible