...
This guide provides instructions to begin using Automation Service Catalog, including prerequisites and procedures for connecting your Ansible Tower provider, as well as configuring users and permissions.

After completing the setup described and following the steps in this guide, you will be able to perform the basic tasks associated with Automation Service Catalog.
...
=== Adding the necessary entitlements for Automation Service Catalog
...
=== Adding a source to sharing a portfolio with users

This section demonstrates the basic workflows required to get started using Automation Service Catalog. We will walk through adding a source and conclude by having a portfolio populated with products that we can share with a group of users.
...
In this onboarding workflow we have demonstrated how to perform the basic actions necessary to produce a portfolio of products ready to share with users.
