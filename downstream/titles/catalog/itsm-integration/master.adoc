...
include::assemblies/assembly-planning-ITSM-integration.adoc[leveloffset=+1]

include::assemblies/assembly-update-playbook-set-stats.adoc[leveloffset=+1]

include::assemblies/assembly-order-process.adoc[leveloffset=+1]

include::assemblies/assembly-itsm-substitution.adoc[leveloffset=+1]
...
2.. The post_set_Stats playbook will gather all the substitued fields and use them in executing the job.
