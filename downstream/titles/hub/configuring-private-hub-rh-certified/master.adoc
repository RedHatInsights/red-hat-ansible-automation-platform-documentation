...
You can synchronize {HubName} to use the Ansible Content Collections available through your {PlatformNameShort} subscription or community collections available through {Galaxy}.
