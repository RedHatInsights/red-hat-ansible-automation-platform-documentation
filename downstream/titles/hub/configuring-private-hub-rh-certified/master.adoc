...
When you download the bundled installer by default Validated Content is pre-populated into the {PrivateHubName}, if the {PrivateHubName} is enabled as part of the inventory.

These collections can be updated manually by downloading their packages.
