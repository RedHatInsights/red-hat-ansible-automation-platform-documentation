...
You can sync {HubName} to use the Red Hat Certified aand Validated Collections available through your {PlatformNameShort} subscription or community collections available through {Galaxy}.

Your organization can access and curate into a unique set of collections from all Red Hat Certified and Validated content in the {HubName} service hosted on console.redhat.com.
